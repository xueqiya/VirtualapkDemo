package com.xueqiya.virtualapkdemo
...
private const val PLUGIN_NAME = "com.xueqiya.plugin.a.apk"
private const val PLUGIN_PKG = "com.xueqiya.plugin.a"
private const val PLUGIN_ACTIVITY = "com.xueqiya.plugin.a.PluginActivity"
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadPlugin(): Boolean {
        val apk = File(cacheDir, PLUGIN_NAME)
        if (apk.exists()) {
            toast("加载插件")
